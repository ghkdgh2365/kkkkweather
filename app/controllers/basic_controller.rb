class BasicController < ApplicationController
    ...
    def chat_control
        ...
        if User.where(user_key: @user_key).exists?
          ...
          Openweather.where(region_id: @user.etc).last.weather[0..7].each do |x|
              if x == "Rain"
                  @rain_news = "(비)비 소식이 있어요 :)"
              end
          end
        ...
        if @response == "지역 등록 하기" or @response == "지역 다시 등록"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "서울", "경기", "인천", "부산", "대구", "광주", "대전", "울산", "강원", "충북", "충남", "전북", "전남", "경북", "경남", "제주", "세종"]
              }
            }
            # 
            render json: @msg, status: :ok
        ...
        if @response == "서울"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "서울특별시 종로구", "서울특별시 중구", "서울특별시 용산구", "서울특별시 성동구", "서울특별시 광진구", "서울특별시 동대문구", "서울특별시 중랑구", "서울특별시 성북구", "서울특별시 강북구", "서울특별시 도봉구", "서울특별시 노원구", "서울특별시 은평구", "서울특별시 서대문구", "서울특별시 마포구", "서울특별시 양천구", "서울특별시 강서구", "서울특별시 구로구", "서울특별시 금천구", "서울특별시 영등포구", "서울특별시 동작구", "서울특별시 관악구", "서울특별시 서초구", "서울특별시 강남구", "서울특별시 송파구", "서울특별시 강동구"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "인천"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "인천광역시 중구", "인천광역시 동구", "인천광역시 남구", "인천광역시 연수구", "인천광역시 남동구", "인천광역시 부평구", "인천광역시 계양구", "인천광역시 서구", "인천광역시 강화군", "인천광역시 옹진군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end                
        ...
        if @response == "부산"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "부산광역시 중구", "부산광역시 서구", "부산광역시 동구", "부산광역시 영도구", "부산광역시 부산진구", "부산광역시 동래구", "부산광역시 남구", "부산광역시 북구", "부산광역시 해운대구", "부산광역시 사하구", "부산광역시 금정구", "부산광역시 강서구", "부산광역시 연제구", "부산광역시 수영구", "부산광역시 사상구", "부산광역시 기장군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end           
        ...
        if @response == "대구"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "대구광역시 중구", "대구광역시 동구", "대구광역시 서구", "대구광역시 남구", "대구광역시 북구", "대구광역시 수성구", "대구광역시 달서구", "대구광역시 달성군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end        
        ...
        if @response == "광주"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "광주광역시 동구", "광주광역시 서구", "광주광역시 남구", "광주광역시 북구", "광주광역시 광산구"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end        
        ...
        if @response == "대전"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "대전광역시 동구", "대전광역시 중구", "대전광역시 서구", "대전광역시 유성구", "대전광역시 대덕구"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end           
        ...
        if @response == "울산"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "울산광역시 중구", "울산광역시 남구", "울산광역시 동구", "울산광역시 북구", "울산광역시 울주군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end        
        ...
        if @response == "강원"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "강원도 춘천시", "강원도 원주시", "강원도 강릉시", "강원도 동해시", "강원도 태백시", "강원도 속초시", "강원도 삼척시", "강원도 홍천군", "강원도 횡성군", "강원도 영월군", "강원도 평창군", "강원도 정선군", "강원도 철원군", "강원도 화천군", "강원도 양구군", "강원도 인제군", "강원도 고성군", "강원도 양양군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "충북"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "충청북도 청주시상당구", "충청북도 청주시서원구", "충청북도 청주시흥덕구", "충청북도 청주시청원구", "충청북도 충주시", "충청북도 제천시", "충청북도 보은군", "충청북도 옥천군", "충청북도 영동군", "충청북도 증평군", "충청북도 진천군", "충청북도 괴산군", "충청북도 음성군", "충청북도 단양군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end        
        ...
        if @response == "충남"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "충청남도 천안시동남구", "충청남도 천안시서북구", "충청남도 공주시", "충청남도 보령시", "충청남도 아산시", "충청남도 서산시", "충청남도 논산시", "충청남도 계룡시", "충청남도 당진시", "충청남도 금산군", "충청남도 부여군", "충청남도 서천군", "충청남도 청양군", "충청남도 홍성군", "충청남도 예산군", "충청남도 태안군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "전북"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "전라북도 전주시완산구", "전라북도 전주시덕진구", "전라북도 군산시", "전라북도 익산시", "전라북도 정읍시", "전라북도 남원시", "전라북도 김제시", "전라북도 완주군", "전라북도 진안군", "전라북도 무주군", "전라북도 장수군", "전라북도 임실군", "전라북도 순창군", "전라북도 고창군", "전라북도 부안군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "전남"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "전라남도 목포시", "전라남도 여수시", "전라남도 순천시", "전라남도 나주시", "전라남도 광양시", "전라남도 담양군", "전라남도 곡성군", "전라남도 구례군", "전라남도 고흥군", "전라남도 보성군", "전라남도 화순군", "전라남도 장흥군", "전라남도 강진군", "전라남도 해남군", "전라남도 영암군", "전라남도 무안군", "전라남도 함평군", "전라남도 영광군", "전라남도 장성군", "전라남도 완도군", "전라남도 진도군", "전라남도 신안군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "경북"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "경상북도 포항시남구", "경상북도 포항시북구", "경상북도 경주시", "경상북도 김천시", "경상북도 안동시", "경상북도 구미시", "경상북도 영주시", "경상북도 영천시", "경상북도 상주시", "경상북도 문경시", "경상북도 경산시", "경상북도 군위군", "경상북도 의성군", "경상북도 청송군", "경상북도 영양군", "경상북도 영덕군", "경상북도 청도군", "경상북도 고령군", "경상북도 성주군", "경상북도 칠곡군", "경상북도 예천군", "경상북도 봉화군", "경상북도 울진군", "경상북도 울릉군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "경남"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "경상남도 창원시 의창구", "경상남도 창원시 성산구", "경상남도 창원시 마산합포구", "경상남도 창원시 마산회원구", "경상남도 창원시 진해구", "경상남도 진주시", "경상남도 통영시", "경상남도 사천시", "경상남도 김해시", "경상남도 밀양시", "경상남도 거제시", "경상남도 양산시", "경상남도 의령군", "경상남도 함안군", "경상남도 창녕군", "경상남도 고성군", "경상남도 남해군", "경상남도 하동군", "경상남도 산청군", "경상남도 함양군", "경상남도 거창군", "경상남도 합천군"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "제주"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "제주특별자치도 제주시", "제주특별자치도 서귀포시"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
        ...
        if @response == "세종"
            @msg = {
              ...
              keyboard: {
                type: "buttons",
                buttons: ["처음으로", "세종특별자치시 세종특별자치시"]# ,"알림 시간 등록"
              }
            }
            render json: @msg, status: :ok
        end
